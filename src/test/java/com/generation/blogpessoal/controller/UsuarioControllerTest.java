...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario (0L,"Paulo Antunes", "paulo_antunes@email.com.br","13328943","-"));
	...
	public void naoDuplicarUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario (0L,"Maria da Silva ramos","maria_silva@email.com.br","13465278","-"));
	...
	public void deveMostrarTodosUsuarios() {
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Sabrina Sanches" , "sabrina_sanches@emaisl.com","sandrine123","-"));
